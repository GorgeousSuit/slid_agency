...
const Advantages = () => {
    return (
        <section className="px-[32px] sm:px-[72px] mt-[96px] sm:mt-[128px]">
            ...
            <div className="mt-[72px] sm:mt-[120px] mb-[96px] sm:mb-[128px] max-sm:space-y-[64px] max-sm:mx-auto max-sm:w-[fit-content]">
                <div className="">
                ...
                <div className="sm:flex sm:justify-end sm:mr-[220px] sm:max-xl:mt[15px] lg:mt-[-44px]">
                    <div className="">
                        ...
                        <p className="mb-[20px] sm:mb-[24px] font-normal text-[24px] sm:text-[40px] leading-[28.8px] sm:leading-[48px]">
                            A comprehensive <br className="hidden sm:block" />{' '}
                            study of
                        ...
                        <p className="font-normal leading-[22.4px] text-[#545454]">
                            ...
                            <br className="hidden sm:block" /> the customers who
                            buy it,
                ...
                <div className="sm:ml-[110px] sm:max-xl:mt[15px] lg:mt-[-24px]">
                    ...
                    <p className="mb-[20px] sm:mb-[24px] font-normal text-[24px] sm:text-[40px] leading-[28.8px] sm:leading-[48px]">
                        Market and <br className="hidden sm:block" /> competitor
                        <br className="sm:hidden" />
                        analysis
                    </p>
                    <p className="font-normal leading-[22.4px] text-[#545454]">
                        ...
                        <br className="hidden sm:block" /> who you compete with.
                        To offer
                        <br className="sm:hidden" /> solutions that will{' '}
                        <br className="hidden sm:block" /> make you better than
                        <br className="sm:hidden" />
                        the rest.
                    </p>
                </div>
                <div className="sm:flex sm:justify-end sm:max-xl:mt[15px] lg:mt-[-66px]">
                    <div className="">
                        ...
                        <p className="font-normal leading-[22.4px] text-[#545454]">
                            ...
                            interested in
                            <br className="sm:hidden" /> its further development
                            and <br className="hidden sm:block" /> will be happy
                            <br className="sm:hidden" /> to share our expertise
                            to help you grow.
                        </p>
                    </div>
                </div>
